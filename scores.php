...
<h1 style="text-align: center"> See high scores for game</h1>
<table style=" width: 100%">
    ...
    <?php
    $query = "SELECT games.ID_games, games.game_name, users.username, users_scores.high_score,"
            . "  users.ID_users, users.username AS user "
            . " FROM users_scores "
            . "  INNER JOIN games  ON games.ID_games=users_scores.ID_games "
            . " INNER JOIN users ON users.ID_users =users_scores.ID_users WHERE games.ID_games = $ID_games";
    //echo $query; die();
    $result = mysqli_query($link, $query);
